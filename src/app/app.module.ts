...
@NgModule({
  declarations: [AppComponent, HeroPickerComponent, CharFilterPipe, CharacterStatsComponent, LightconePickerComponent, LcFilterPipe, RelicsComponent, SetEffectsComponent],
